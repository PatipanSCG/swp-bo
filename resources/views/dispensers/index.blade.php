...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">ตารางหัวจ่ายน้ำมัน</h6>
    </div>
    <div class="card-body">
...
$(document).ready(function() {
    $('#dispenserTable').DataTable({
        ajax: '{{env('APP_URL')}}stations/{{ $station->StationID }}/dispensers/data',
        columns: [
            ...
            { data: 'PurchaseDate' },
            {
                ...
                render: function (data, type, row, meta) {
                    return '<a href="/stations/' + row.DispenserCode + '/dispensers" class="btn btn-info btn-sm">จัดการหัวจ่าย</a>';
                }
            }
        ],
        language: {
